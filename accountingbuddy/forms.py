...
class BusinessRequestForm(forms.Form):
	...
	sales_invoice=forms.FileField(help_text="Upload your present Sales Invoice if any",required=True)
	purchase_invoice=forms.FileField(help_text="Upload your present Purchase Invoice if any",required=True)
	pay_slip=forms.FileField(help_text="Upload your present Pay Slip if any",required=True)
	talley_file=forms.FileField(help_text="Upload your present Talley Export if any",required=True)
