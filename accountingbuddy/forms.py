...
class BusinessRequestForm(forms.Form):
	...
	sales_invoice=froms.FielField(max_length='100',validators=[file_size],help_text="Upload your present Sales Invoice if any",required=False)
	purchase_invoice=froms.FielField(max_length='100',validators=[file_size],help_text="Upload your present Purchase Invoice if any",required=False)
	pay_slip=froms.FielField(max_length='100',validators=[file_size],help_text="Upload your present Pay Slip if any",required=False)
	talley_file=froms.FielField(max_length='100',validators=[file_size],help_text="Upload your present Talley Export if any",required=False)
